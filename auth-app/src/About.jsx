...
const About = () => {
    return (
        <div>
            ...
            clave en la industria. Con objetivos claros y definidos, el proyecto se centra en:   
            </p>
            <li>
            ...
            <p>El éxito de este proyecto no solo mejorará la operatividad interna, sino que también ofrecerá una visión más clara y estratégica para la toma de decisiones en el futuro.</p>
            <Link to="/Dashboard">
                <button>
                    Volver
                </button>
