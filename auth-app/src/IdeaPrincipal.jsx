...
const IdeaPrincipal = () => {
    return (
        <div>
            ...
            para los clientes.</p> 
            <div> 
            <u><strong>-Problematicas a abordar en el problema</strong></u>
            <p>-Registro de Ventas y Ganancias por Mes: Actualmente, la librería carece de un sistema automatizado 
            ...
            <p>-Análisis de Ventas de Libros: Sin un mecanismo para analizar las ventas de libros, es difícil identificar 
            ...
            <p>-Control de Inventario: La librería también enfrenta desafíos en la gestión de su inventario de productos diversos, 
